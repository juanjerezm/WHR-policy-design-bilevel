...
if __name__ == "__main__":
    ...
    PLOTNAME = "EmissionSummary-2"
    SAVE = True
    SHOW = True

    SCALE = 8760 / 73 * 1e-6 # Temporal scaling + ton to Mton
    FIGSIZE = (18.5, 11)  # cm
    DPI = 600
    
    FORMATTED_XAXIS = True
    X_RANGE = (-1.2, 0.3)
    X_STEPS = (0.3, 0.15) # major and minor ticks
    X_LABEL = "Change in carbon emissions\n(Mton/year)"
    ...
    main(inputfile="ModelRuns-2.csv", var="x_h", multiplier="omega")
