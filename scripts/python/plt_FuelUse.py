...
from chp_deficit import deficit
...
def main(var):
    ...
    chp_deficit = deficit(input_path, var) * -1
    ...
    data = pd.concat([data, chp_deficit], axis=1)
...
if __name__ == "__main__":
    ...
    WIDTH   = 9 # cm
    HEIGHT  = 11 # cm
    Y_TITLE = "Fuel Consumption Change [TWh/year]"
    # Y_RANGE = (-2.80, +1.40) #T095
    # Y_STEP  = 0.7 #T095
    Y_RANGE = (-12, +9.00) #U095
    Y_STEP  = 3 #U095
